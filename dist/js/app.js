...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('h1',[_vm._v("Page not found")])}
...
},{"./Main.vue":5,"./Router":6,"./components/store/HeroesStore.js":15,"vue":25,"vue-paginate":22,"vue-resource":23,"vuetify":26}],3:[function(require,module,exports){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-row',[_c('v-col',{staticClass:"list-heroes",attrs:{"xs12":"xs12","sm9":""}},[_c('short-by'),_vm._v(" "),(!_vm.$store.state.isLoad)?_c('div',[_c('v-progress-circular',{staticClass:"red--text",attrs:{"indeterminate":""}})],1):_vm._e(),_vm._v(" "),(_vm.$store.state.isLoad)?_c('paginate',{staticClass:"paginate-list",attrs:{"name":"heroes","list":_vm.heroes,"per":10}},_vm._l((_vm.paginated('heroes')),function(hero){return _c('hero',{attrs:{"data":hero}})})):_vm._e(),_vm._v(" "),(_vm.$store.state.isLoad)?_c('paginate-links',{attrs:{"for":"heroes","limit":5,"show-step-links":true,"step-links":{ next: '>', prev: '<'}}}):_vm._e()],1),_vm._v(" "),_c('v-col',{staticClass:"aside",attrs:{"xs12":"xs12","sm3":""}},[_c('aside-left')],1)],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
var _Modal = require('./components/modal/Modal.vue');
...
exports.default = {
    name: 'app',
    components: { AppHeader: _Header2.default, AppFooter: _Footer2.default, Modal: _Modal2.default },
    data: function data() {
        return {};
    }
};
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('modal'),_vm._v(" "),_c('app-header'),_vm._v(" "),_c('div',{staticClass:"container app-content"},[_c('router-view')],1),_vm._v(" "),_c('app-footer')],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"./404.vue":1,"./HomeApp.vue":4,"vue":25,"vue-router":24}],7:[function(require,module,exports){
;(function(){
'use strict';
    ...
    state: {
        ...
        updateHeroes: function updateHeroes(http, search) {
            ...
            if (search != "") {
                ...
                this.isLoad = false;
                http.get(_Constants.CONFIG.URL_BASE + '?nameStartsWith=' + starWith + '&limit=100&ts=1&apikey=' + _Constants.CONFIG.API_KEY + '&hash=' + _Constants.CONFIG.HASH).then(function (response) {
                    _this2.addHeroes(response.body.data.results);
                }, function (response) {
                    // error callback
                    console.log(response);
                });
...
},{"../../Constants":3,"babel-runtime/core-js/json/stringify":16,"vue":25,"vue-resource":23,"vuex":27}],16:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/json/stringify"), __esModule: true };
},{"core-js/library/fn/json/stringify":18}],17:[function(require,module,exports){
...
},{"../../modules/_core":19}],19:[function(require,module,exports){
...
(function (global, factory) {
	(typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.VuePaginate = factory();
})(undefined, function () {
	'use strict';
	...
	warn = function warn(msg, vm, type) {
  ...
  */
	function set$1(obj, key, val) {
		...
		if (obj._isVue || ob && ob.vmCount) {
			"production" !== 'production' && warn$1('Avoid adding reactive properties to a Vue instance or its root $data ' + 'at runtime - declare it upfront in the data option.');
			return;
		}
		if (!ob) {
			obj[key] = val;
  ...
  */
	function del(obj, key) {
		var ob = obj.__ob__;
		if (obj._isVue || ob && ob.vmCount) {
			"production" !== 'production' && warn$1('Avoid deleting properties on a Vue instance or its root $data ' + '- just set it to null.');
			return;
		}
		if (!hasOwn(obj, key)) {
			return;
	...
	strats.data = function (parentVal, childVal, vm) {
		if (!vm) {
			...
			if (typeof childVal !== 'function') {
				"production" !== 'production' && warn$1('The "data" option should be a function ' + 'that returns a per-instance value in component ' + 'definitions.', vm);
				return parentVal;
			}
			if (!parentVal) {
				return childVal;
  ...
  */
	function getPropDefaultValue(vm, prop, key) {
		...
		if (isObject(def)) {
			"production" !== 'production' && warn$1('Invalid default value for prop "' + key + '": ' + 'Props with type Object/Array must use a factory function ' + 'to return the default value.', vm);
		}
	...
	var Watcher = function Watcher(vm, expOrFn, cb, options) {
		...
		if (typeof expOrFn === 'function') {
			...
			if (!this.getter) {
				...
				"production" !== 'production' && warn$1("Failed watching path: \"" + expOrFn + "\" " + 'Watcher only accepts simple dot-delimited paths. ' + 'For full control, use a function instead.', vm);
			}
		}
				...
				if (this.user) {
					try {
						...
						if (config.errorHandler) {
							...
							"production" !== 'production' && warn$1("Error in watcher \"" + this.expression + "\"", this.vm);
							throw e;
						}
					}
				} else {
  ...
  */
	...
	function initData(vm) {
		...
		if (!isPlainObject(data)) {
			data = {};
			"production" !== 'production' && warn$1('data functions should return an object:\n' + 'https://vuejs.org/v2/guide/components.html#data-Must-Be-a-Function', vm);
		}
		...
		while (i--) {
			if (props && hasOwn(props, keys[i])) {
				"production" !== 'production' && warn$1("The data property \"" + keys[i] + "\" is already declared as a prop. " + "Use prop default value instead.", vm);
			} else {
				proxy(vm, keys[i]);
			}
		}
	...
	function updateListeners(on, oldOn, add, remove$$1, vm) {
		...
		for (name in on) {
			...
			old = oldOn[name];
			if (!cur) {
				"production" !== 'production' && warn$1("Invalid handler for event \"" + name + "\": got " + String(cur), vm);
			} else if (!old) {
	...
	function resolveAsyncComponent(factory, baseCtor, cb) {
		if (factory.requested) {
			...
			var reject = function reject(reason) {
				"production" !== 'production' && warn$1("Failed to resolve async component: " + String(factory) + (reason ? "\nReason: " + reason : ''));
			};
	...
	function _createElement(context, tag, data, children, normalizationType) {
		if (data && data.__ob__) {
			"production" !== 'production' && warn$1("Avoid using observed data object as vnode data: " + JSON.stringify(data) + "\n" + 'Always create fresh vnode data objects in each render!', context);
	...
	function renderMixin(Vue) {
		...
		Vue.prototype._t = function (name, fallback, props, bindObject) {
			...
			if (scopedSlotFn) {
				...
				if (slotNodes && "production" !== 'production') {
					slotNodes._rendered && warn$1("Duplicate presence of slot \"" + name + "\" found in the same render tree " + "- this will likely cause render errors.", this);
		...
		Vue.prototype._b = function bindProps(data, tag, value, asProp) {
			if (value) {
				if (!isObject(value)) {
					"production" !== 'production' && warn$1('v-bind without argument expects an Object or Array value', this);
				} else {
					if (Array.isArray(value)) {
  ...
  */
	function query(el) {
		if (typeof el === 'string') {
			...
			if (!el) {
				"production" !== 'production' && warn$1('Cannot find element: ' + selector);
  ...
  */
	...
	function setSelected(el, binding, vm) {
		...
		if (isMultiple && !Array.isArray(value)) {
			"production" !== 'production' && warn$1("<select multiple v-model=\"" + binding.expression + "\"> " + "expects an Array value for its binding, but got " + Object.prototype.toString.call(value).slice(8, -1), vm);
			return;
		}
		var selected, option;
	...
	function getLimitedLinks(vm, h) {
		var limitedLinks = new LimitedLinksGenerator(vm.listOfPages, vm.currentPage, vm.limit, vm.stepLinks).generate();
...
},{"got":17}],24:[function(require,module,exports){
(function (process){
/**
  * vue-router v2.2.1
  * (c) 2017 Evan You
